...
function App() {
  ...
  const [option1, setOption1] = useState(
    localStorage.getItem("option1") || "state"
  );
  const [option2, setOption2] = useState(
    localStorage.getItem("option2") || "priority"
  );
    ...
    <>
      <div className="header">
        <button className="selector" onClick={() => setClick((x) => !x)}>
          <img className="display-img" src={Display} />
          Display
          <img className="down-img" src={down} />
        </button>
        {click && (
          <div className="option-cont">
            <label className="opt1" htmlFor="option1">
              Grouping
            </label>
            <select
              value={option1}
            ...
            <br></br>
            <br></br>
            <label className="opt2" htmlFor="option2">
              Ordering
            </label>
            <select
              value={option2}
              ...
              <div className="section1">
                <div className="image-cont1">
                  ...
                  {option1 === "user" && (
                    <div
                      className={`${
                        users.filter((user) => user.name === key)[0]?.available
                      }`}
                    ></div>
                  )}
                </div>
                ...
                <img className="dotmenu" src={dotmenu} />
              </div>
